  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <p className="text-center text-5xl font-bold max-sm:text-3xl max-sm:pb-3">
          About Me
        </p>
      </div>
          ...
          <div className="flex justify-between items-center gap-10 w-full max-xl:gap-4 max-xl:flex-col">
            <div className="flex flex-col justify-center items-center  border-2 border-[#ff8080] rounded-lg w-full max-xl:w-max max-xl:px-20 py-4 max-md:p-1 max-md:w-full">
              <svg
                ...
                width="35px"
                className="fill-[#ff8080] max-sm:hidden"
              >
                <path d="m344-60-76-128-144-32 14-148-98-112 98-112-14-148 144-32 76-128 136 58 136-58 76 128 144 32-14 148 98 112-98 112 14 148-144 32-76 128-136-58-136 58Zm34-102 102-44 104 44 56-96 110-26-10-112 74-84-74-86 10-112-110-24-58-96-102 44-104-44-56 96-110 24 10 112-74 86 74 84-10 114 110 24 58 96Zm102-318Zm-42 142 226-226-56-58-170 170-86-84-56 56 142 142Z" />
              </svg>
              <p className="font-bold text-2xl max-lg:text-lg max-sm:underline">
                Experience
              </p>
              <p className="font-semibold">Working at PageSuite</p>
              <p className="max-md:text-sm">2 Years + </p>
              <p className="max-md:text-sm">Full-Stack Software Engineer</p>
            </div>
            <div className="max-md:p-1 flex flex-col justify-center items-center border-2 border-[#ff8080] rounded-lg w-full py-7 max-xl:w-max max-xl:px-20 max-md:w-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="35px"
                viewBox="0 -960 960 960"
