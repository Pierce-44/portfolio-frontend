  ...
  return (
    ...
    >
      <div className="space-y-4 max-sm:space-y-0">
        ...
        <p className="text-center text-5xl font-bold max-sm:text-3xl max-lg:pb-4 max-[400px]:pb-4 dark:text-white">
          About Me
        </p>
      </div>
        ...
        <div className="flex flex-col justify-start items-start gap-20 max-sm:gap-10">
          <div className="flex flex-row-reverse justify-center items-center gap-10 max-sm:pt-10 max-sm:flex-col-reverse max-sm:items-start max-sm:self-start ">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="border-l-2 border-[#ff8080] pl-4 max-sm:text-sm max-[400px]:text-[10px] dark:text-gray-300">
                <p className="font-semibold dark:text-white">Experience</p>
                <p>
          ...
          <div className="flex gap-4 items-center">
            ...
            <p className="max-w-[810px] border-l-2 border-[#ff8080] pl-4 max-sm:text-sm max-[400px]:text-[10px] dark:text-gray-300">
