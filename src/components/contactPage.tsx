...
export default function ContactPage({ contactRef }: Props) {
  return (
    <div
      ref={contactRef}
    ...
    >
      <div className="space-y-4">
        ...
        <div className="max-md:mx-4 !my-24 font-semibold text-lg flex items-center justify-center gap-24 max-md:gap-4 max-md:flex-wrap border border-[#383838] rounded-full p-10 max-md:px-5 max-md:py-5">
